      ...
      <div className="container mx-auto px-5 relative z-10">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 text-pink-300 mb-6">
            ...
            <span className="text-xl font-medium">Let's Hash It Up!</span>
            <FaHeart className="text-pink-400" />
          </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <p className="text-[20px] text-gray-200 max-w-4xl mx-auto leading-relaxed font-light">
              We'd love to hear from you & explore how HASH Solutions can help
              your business grow. Get in touch with us today!
            </p>
            {/* Underline Animation */}
            <motion.div
              initial={{ width: 0 }}
