...
const StickerPeel = ({
  ...
  useEffect(() => {
    ...
    if (initialPosition === "center") {
      ...
      startX = (windowWidth - targetRect.width) / 2;
      startY = (windowHeight - targetRect.height) / 2;
    } else if (
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      if (draggableInstanceRef.current) {
        ...
        const maxX = windowWidth - targetRect.width;
        const maxY = windowHeight - targetRect.height;
